# Alexstrasza OTK Combo Guides

Reference documents for Darkscale/Alexstrasza-style Rogue OTK combos —
exhaustive breakdowns of how to sequence the combo under
different hand states, mana totals, and available tech cards (Step, Prep,
Potion of Illusion, Shadow of Demise, etc.).

These decks are complex enough that finding the most efficient
*maximum-damage, minimum-resource* line is nearly impossible within the turn timer.
That's what these documents map out.

## Files, and who did what
...
**`wulex.pdf`** -- archived from a Discord thread by danilatrunovx. I didn't
discover or originally post these lines; I compiled and organized them
